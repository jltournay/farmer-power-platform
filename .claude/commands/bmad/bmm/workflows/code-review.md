...
<steps CRITICAL="TRUE">
1. Use the Read tool to LOAD the FULL file: _bmad/core/tasks/workflow.xml
2. READ its entire contents - this is the CORE OS for EXECUTING the specific workflow-config
3. Use the Read tool to LOAD the workflow config: _bmad/bmm/workflows/4-implementation/code-review/workflow.yaml
