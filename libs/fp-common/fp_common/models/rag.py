"""RAG retrieval domain models for Farmer Power Platform.

This module defines Pydantic models for RAG retrieval operations shared
between the ai-model service and BFF:
...
Story 0.75.23: Moved from ai_model/domain/retrieval.py to fp-common for BFF sharing

Reference:
- Proto definition: proto/ai_model/v1/ai_model.proto (QueryKnowledge messages)
- Original location: services/ai-model/src/ai_model/domain/retrieval.py
"""
