...
class Farmer(BaseModel):
    ...
    # collection_point_id removed - Story 9.5a: N:M relationship via CP.farmer_ids
...
class FarmerCreate(BaseModel):
    ...
    # collection_point_id removed - Story 9.5a: use separate assignment API
    grower_number: str | None = Field(default=None, description="External/legacy grower number")
