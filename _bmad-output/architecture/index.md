...
date: '2025-12-16'](#stepscompleted-1-inputdocuments-bmad-outputanalysisproduct-brief-farmer-power-platform-2025-12-16md-workflowtype-architecture-laststep-1-projectname-farmer-power-platform-username-jeanlouistournay-date-2025-12-16)
  - [Architecture Decision Records (ADRs)](./adr/index.md)
    ...
    - [ADR-006: Event Delivery and Dead Letter Queue](./adr/ADR-006-event-delivery-dead-letter-queue.md)
  ...
  - [Action Plan Model Architecture](./action-plan-model-architecture.md)
    ...
    - [Voice IVR System](./action-plan-model-architecture.md#voice-ivr-system)
      ...
      - [SMS → Voice Handoff](./action-plan-model-architecture.md#sms-voice-handoff)
  ...
  - [AI Model Architecture](./ai-model-architecture/index.md) *(sharded)*
    - [Overview](./ai-model-architecture/overview.md)
    - [Document Boundaries](./ai-model-architecture/document-boundaries.md)
    - [Architecture Diagram](./ai-model-architecture/architecture-diagram.md)
    - [Communication Pattern](./ai-model-architecture/communication-pattern.md)
    - [Agent Types](./ai-model-architecture/agent-types.md)
    - [Agent Configuration Schema](./ai-model-architecture/agent-configuration-schema.md)
    - [Agent Type Design Decisions](./ai-model-architecture/agent-type-design-decisions.md)
    - [LangGraph Workflow Orchestration](./ai-model-architecture/langgraph-workflow-orchestration.md)
    - [Triggering](./ai-model-architecture/triggering.md)
    - [LLM Gateway](./ai-model-architecture/llm-gateway.md)
    - [Tiered Vision Processing](./ai-model-architecture/tiered-vision-processing-cost-optimization.md)
    - [RAG Engine](./ai-model-architecture/rag-engine.md)
    - [RAG Document API](./ai-model-architecture/rag-document-api.md)
    - [Prompt Management](./ai-model-architecture/prompt-management.md)
    - [RAG Knowledge Versioning](./ai-model-architecture/rag-knowledge-versioning.md)
    - [Configuration Strategy](./ai-model-architecture/configuration-strategy.md)
    - [Observability](./ai-model-architecture/observability.md)
    - [Key Decisions](./ai-model-architecture/key-decisions.md)
    - [Testing Strategy](./ai-model-architecture/testing-strategy.md)
    - [Developer Guide](./ai-model-architecture/developer-guide.md)
