...
- Uses BFF endpoints from Story 9.6a:
  - `GET /api/admin/grading-models`
  - `GET /api/admin/grading-models/{id}`
  - `POST /api/admin/grading-models/{id}/assign`
- Reuse shared components from Story 9.1b (DataTable, DetailCard, etc.)
- Read-only display - no edit/create functionality

## Dependencies
- Story 9.6a: Grading Model gRPC + BFF API (provides backend endpoints)
