...
- **Boundary Storage**: GeoJSON Polygon format in MongoDB
  ...
  ```
- **Map Library**: Leaflet.js with OpenStreetMap tiles (free) or Mapbox (premium option)
- **Drawing Plugin**: Leaflet.draw for polygon/circle drawing capabilities
- Centroid and area auto-calculated using Turf.js or similar geospatial library
