"""Collection MCP Server - gRPC server entrypoint."""
...
async def serve() -> None:
    ...
    logger.info(
        "Starting Collection MCP Server",
    ...
    blob_url_generator = BlobUrlGenerator(
        ...
        validity_hours=settings.sas_token_validity_hours,
    )
    ...
    logger.info("Collection MCP Server started", address=listen_addr)
